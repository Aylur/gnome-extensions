...
class PowerDialog extends ModalDialog.ModalDialog{
    ...
    layout2x2(){
        let vbox = new St.BoxLayout({ style: this._spacing, vertical: true });
        let hbox1 = new St.BoxLayout({ style: this._spacing });
        let hbox2 = new St.BoxLayout({ style: this._spacing });
    ...
    layout1x4(){
        let hbox = new St.BoxLayout({ style: this._spacing });
...
var Extension = class Extension {
    ...
    enable() { this._extension.enable() }
    disable() { this._extension.disable() }
}
